...
menuRouter.get('/api/v1/menus/:DD/:MM/:YYYY', _menus3.validateParams, _menus2.default.getMenu);

menuRouter.get('/api/v1/menus', _adminOnly2.default, _menus2.default.getAllMenus);

menuRouter.post('/api/v1/menus', _adminOnly2.default, _menus3.validateMenu, _menus2.default.postMenu);

menuRouter.put('/api/v1/menus/:DD/:MM/:YYYY', _adminOnly2.default, _menus3.validateParams, _menus3.validateUpdateMenu, _menus2.default.updateMenu);
